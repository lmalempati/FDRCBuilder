...
public class Constants {
    ...
    public static final String REQUEST_MERCHID =  "RCTST1000091556"; // "RCTST1000091557";
    //"RCTST1000092492"; moto old one
    public static final String REQUEST_GROUPID = "10001";
...
//    public static final String HTTP_DID = "00035469814383142846"; /*Restaurant*/
    public static final String HTTP_DID = "00041198330131720090"; /*Restaurant*/
